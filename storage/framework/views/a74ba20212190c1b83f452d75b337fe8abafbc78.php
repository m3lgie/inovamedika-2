...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">   Aplication | Point of Sale</a>
            </div>
                 ...
                 <ul class="list">
                     ...
                     <li>
                         ...
                         <ul class="ml-menu">
                           ...
                           <li>
                               <a href="<?php echo e(url('/product_unit')); ?>">Products Unit</a>
                           </li>
                     ...
                     <?php endif; ?>
                         ...
                         <li>
                             ...
                             <ul class="ml-menu">
                                   ...
                                   <li>
                                       <a href="<?php echo e(url('/transactions')); ?>">Transactions</a>
                                   </li>

                                    <li>
                                        <a href="<?php echo e(URL::route('transactions.create')); ?>">Add Transactions</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(URL::route('report')); ?>">Report</a>
                                    </li>
    ...
    <script src="<?php echo e(asset('template/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js')); ?>"></script>
