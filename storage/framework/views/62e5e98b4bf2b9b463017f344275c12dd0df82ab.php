<div class="item form-group ">
	...
	<table class="table table-striped table-hover">
			...
			<tbody id='order'>
				...
				$totaldisc=0;
				 ?>
    <?php $__currentLoopData = $draft_transaction_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
		...
		<label class="control-label col-sm-12" for="name">Order Details</label>
									...
									<br>
									<label class="control-label col-sm-12" for="name"><?php echo e($draft_transactions[0]->customer_name); ?> </label>
									...
									<br>
									<label class="control-label col-sm-12" for="name"><?php echo e($draft_transactions[0]->customer_phone); ?> </label>
									...
									<br>
									<label class="control-label col-sm-12" for="name"><?php echo e(Konversi::rupiah($draft_transactions[0]->payment)); ?> </label>
									...
									<br>
									<label class="control-label col-sm-12" for="name"><?php echo e($draft_transactions[0]->notes); ?> </label>
